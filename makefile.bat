...
ca65 --cpu 65C02 duart.asm -o ..\output\duart.o
...
ld65 -C ..\config\APP_RAM_DISK.cfg -m main.map main.o duart.o kernel_c_lib.o interrupts.o vectors.o ..\library\p65.lib -o ..\output\RAM.bin


ld65 -C ..\config\APP_RAM_DISK.cfg test_asm.o kernel_c_lib.o interrupts.o vectors_asm.o duart.o -o ..\output\RAM_ASM.bin
